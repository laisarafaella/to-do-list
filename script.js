...
// array
let atividades = [
    // atividade, {} - se eu tivesse pegando do objeto
    {
        nome: "Academia",
        //objeto new Date("")
        data: "2024-07-08 12:00",
        finalizada: true
    },
    {
        nome: "Trilha",
        data: "2024-11-27 06:00",
        finalizada: false
    },
    {
        nome: "Gamming Session",
        data: "2024-07-14 16:00",
        finalizada: true
    },
    {
        nome: "Visita ao Planetário",
        data: "2024-11-27 19:30",
        finalizada: false
    }
...
const salvarAtividade = (event) => {
    ...
    const atividadeExiste = atividades.some((atividade) => {
        return atividade.data.toLowerCase() == novaAtividade.data.toLowerCase() && !atividade.finalizada
    })
...
const criarDiasSelecao = () => {
    ...
    for(let mes = 0; mes < 12; mes++) {
        ...
        const diasMes = new Date(anoAtual, mes + 1, 0).getDate()
